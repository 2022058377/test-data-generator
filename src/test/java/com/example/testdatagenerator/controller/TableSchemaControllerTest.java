...
class TableSchemaControllerTest {
    ...
    void givenAuthenticatedUserAndSchemaName_whenRequesting_thenShowTableSchemaView() throws Exception {
        ...
        given(tableSchemaService.loadMySchema(githubUser.id(), schemaName))
                .willReturn(TableSchemaDto.of(schemaName, githubUser.id(), null, Set.of()));
    ...
    void givenTableSchema_whenDownloading_thenReturnsFile() throws Exception {
        ...
        mvc.perform(get("/table-schema/export?" + queryParam))
                ...
                .andExpect(header().string(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=test_schema.csv"))
